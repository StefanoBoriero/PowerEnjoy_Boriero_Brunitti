\subsubsection{InfractionManager, DatabaseController} 
...
\subsubsection{LoginManager, DatabaseController}
\begin{tabular}{|p{5cm}|p{7cm}|}
\hline
...
\subsubsection{PersonalInformationEditor, DatabaseController}
\begin{tabular}{|p{5cm}|p{7cm}|}
\hline
