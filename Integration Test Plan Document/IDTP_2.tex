...
\input{IntegrationStrategy/Entry_criteria.tex}

\subsection{Elements to be Integrated}
\input{IntegrationStrategy/Elements_to_be_integrated.tex}

\subsection{Integration Testing Strategy}
\input{IntegrationStrategy/Integration_testing_strategy.tex}
...
\newpage
\input{IntegrationStrategy/CustomerStrategy/CustomerStrategy.tex}

\newpage
\subsubsection{Subsystem Integration Sequence}
\input{IntegrationStrategy/Subsystem_integration_strategy.tex}
...
\input{IntegrationStrategy/CustomerStrategy/ReservationController/TestingDescription.tex}
\input{IntegrationStrategy/CustomerStrategy/BalanceController/TestingDescription.tex}
\input{IntegrationStrategy/CustomerStrategy/AccountController/TestingDescription.tex}
\input{IntegrationStrategy/CustomerStrategy/RegistrationController/TestingDescription.tex}
\input{IntegrationStrategy/CustomerStrategy/ReportController/TestingDescription.tex}
\input{IntegrationStrategy/CustomerStrategy/Dispatcher/TestingDescription.tex}

\subsection{Subsystem Integration}
\input{IntegrationStrategy/Subsystem_integration_description.tex}
\newpage
